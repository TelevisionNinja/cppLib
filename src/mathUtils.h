...
namespace tvnj {
   ...
   * @return std::vector<double> 
   */
   std::vector<double> backward_differentiation_formula_order_6_implicit_step(std::vector<double> y_n, double t, double dt, std::function<std::vector<double>(double, std::vector<double>)> function, double tolerance = 0.0000001, size_t max_iterations = 1024);
